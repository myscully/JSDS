...
:root{
  --accent-50:#EFF3FB; --accent-100:#D7E0F4; --accent-200:#AEC1EA; --accent-300:#8AA7E7; --accent-400:#648CE4;
  --accent-500:#4375E4; --accent-600:#2563EB; --accent-700:#1249C2; --accent-800:#0D3691; --accent-900:#09245F;
}`;
const PAGES = {
...
<div class="kv"><dt>React</dt><dd><code>applyAccent("#2563EB")</code> 한 줄. 런타임에 <code>--accent-50~900</code> 을 생성해 <code>:root</code> 에 넣습니다</dd><dt>HTML+CSS</dt><dd>아래처럼 <code>:root</code> 에 덮어씁니다. HEX 하나로 10단계를 만드는 함수는 <a href="#/resources/design-token#accent-js">Design Token › Accent 스케일 생성</a></dd><dt>미리보기</dt><dd>이 사이트 헤더의 <b>Accent</b> 선택으로 각 제품 컬러가 적용된 모습을 볼 수 있습니다. 실제 제품 컬러는 <code>_build/data.js</code> 의 <code>PRODUCTS</code> 에 등록합니다</dd><dt>브랜드</dt><dd><code>#FF7F00</code>(<code>--brand</code>)은 제품 UI 의 Accent 선택지가 아닙니다. 로고·헤더 마크 같은 회사 정체성 표기에만 쓰고, 브랜드 디자인 시스템은 별도로 제작합니다</dd></div>
