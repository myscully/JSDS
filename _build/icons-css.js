...
const RULES = [
  ...
  [".checkbox input:indeterminate::after,.checkbox input.mixed::after", `content:"";width:12px;height:12px;background:var(--accent-on);${mask("minus", "outline", { strokeWidth: 3.5 })}`],
  [".chip[aria-pressed]::before", `content:"";width:14px;height:14px;flex:none;background:var(--text-disabled);${mask("check")}`],
