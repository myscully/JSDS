...
${sem("brand", "Brand", "지란지교시큐리티 브랜드 컬러입니다. 로그인·온보딩처럼 회사 정체성이 필요한 화면의 포인트나 로고·헤더 마크에 사용하고, 제품 화면 안의 액션에는 Primary(제품 컬러)를 우선합니다. 둘을 한 화면에서 나란히 강조하지 않습니다.", [["Normal", "--brand"], ["Subtle", "--brand-subtle"]])}
