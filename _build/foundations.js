...
${tbl(["역할", "토큰", "쓰는 곳", "쓰지 않는 곳"], [
  ["<b>제품 Primary</b><br><small>제품 메인 컬러 슬롯</small>", "<code>--accent</code> <code>--accent-hover</code> <code>--accent-pressed</code> <code>--accent-subtle</code> <code>--accent-on</code>", "주요 행동 버튼(화면당 하나), 링크, 활성·선택 상태(탭 · 내비게이션 · 체크 · 스위치), 포커스 링", "위험도나 처리 결과 표현, 넓은 면의 장식 배경, 로고"],
  ["<b>Status</b><br><small>처리 결과</small>", "<code>--success</code> <code>--warning</code> <code>--danger</code> <code>--info</code> + <code>-subtle</code>", "성공·실패·검토 대기 알림(토스트 · 배너 · 인라인 메시지), 입력 검증 오류, 파괴적 행동 버튼(<code>danger</code>)", "위협 등급(심각도) 표현, 탐색·선택 상태, 브랜드 강조"],
  ["<b>Severity</b><br><small>보안 위협 등급</small>", "<code>--sev-critical</code> <code>--sev-high</code> <code>--sev-medium</code> <code>--sev-low</code> <code>--sev-info</code> + <code>-bg</code>", "위협·이벤트 등급 태그, 점·밴드, 표 행 강조, 대시보드 KPI. <b>항상 라벨(Critical 등)을 병기</b>", "버튼·링크, 일반 처리 결과(성공/실패), 색만 있는 점·배경"],
  ["<b>Brand</b><br><small>회사 정체성</small>", "<code>--brand</code> <code>--brand-subtle</code>", "로고 · 헤더 마크, 로그인 · 온보딩의 회사 정체성 표기", "제품 UI 의 Accent · CTA · 위험도 · 상태. 헤더 Accent 선택지에 없음 — 브랜드 디자인 시스템은 별도 제작"],
  ["<b>Gray</b><br><small>바탕과 구조</small>", "<code>--bg-*</code> <code>--text-*</code> <code>--border-*</code> <code>--fill-*</code> <code>--line-*</code>", "화면 바탕, 텍스트, 구분선, 비활성 상태. 정보 밀도가 높은 콘솔의 기본 색", "강조. 회색 톤 차이만으로 상태나 등급을 표현"]
])}
<div class="dodont">
  <div class="do"><div class="panel left" style="min-height:0;padding:var(--space-6);display:flex;gap:12px;align-items:center;flex-wrap:wrap"><button type="button" class="btn md primary">정책 저장</button><button type="button" class="btn md secondary">취소</button><span style="margin-left:auto;display:inline-flex;align-items:center;gap:8px;font-size:14px;font-weight:600"><i style="width:18px;height:18px;border-radius:50%;background:var(--brand);display:inline-block"></i>JS Console</span></div><div class="body"><p>주요 행동은 제품 Primary, 회사 정체성은 헤더 마크에만. 두 색이 같은 화면에 있어도 역할이 겹치지 않습니다.</p></div></div>
  <div class="dont"><div class="panel left" style="min-height:0;padding:var(--space-6);display:flex;gap:12px;align-items:center;flex-wrap:wrap"><button type="button" class="btn md primary" style="background:var(--brand)">정책 저장</button><button type="button" class="btn md secondary" style="color:var(--brand);border-color:var(--brand)">취소</button></div><div class="body"><p>브랜드 색을 CTA 나 보조 버튼에 쓰지 않습니다. 제품 컬러가 바뀌어도 브랜드 색은 그대로라 제품 간 구분이 사라지고, 강조 위계도 깨집니다.</p></div></div>
  <div class="do"><div class="panel left" style="min-height:0;padding:var(--space-6);display:flex;gap:8px;align-items:center;flex-wrap:wrap"><span class="tag critical">Critical</span><span class="tag high">High</span><span class="tag medium">Medium</span><span class="tag low">Low</span><span class="tag info">Info</span></div><div class="body"><p>심각도는 Severity 색 + 라벨을 함께 씁니다. 색을 구분하지 못해도 등급을 읽을 수 있고, 다크 테마에서도 의미가 같습니다.</p></div></div>
  <div class="dont"><div class="panel left" style="min-height:0;padding:var(--space-6);display:flex;gap:12px;align-items:center;flex-wrap:wrap"><i style="width:12px;height:12px;border-radius:50%;background:var(--sev-critical);display:inline-block"></i><i style="width:12px;height:12px;border-radius:50%;background:var(--sev-high);display:inline-block"></i><i style="width:12px;height:12px;border-radius:50%;background:var(--sev-medium);display:inline-block"></i><button type="button" class="btn md primary" style="background:var(--sev-critical)">차단</button></div><div class="body"><p>색만 있는 점으로 등급을 전달하거나, 심각도 색을 버튼에 쓰지 않습니다. 파괴적 행동은 Status 의 <code>danger</code> 버튼입니다.</p></div></div>
</div>
